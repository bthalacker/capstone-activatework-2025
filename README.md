...
## Data Analytics Capstone — Budget vs Actual
...
2. Part 1 optional: run `part1_excel_mysql/sql/creditcard_capstone.sql` in MySQL if you want to rebuild tables.  
